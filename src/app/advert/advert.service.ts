...
// Messaging message results
    ...
    constructor(private http: HttpClient){
        setString("sm-service-ratings-host", "http://10.10.100.148:9957");
        setString("sm-service-advert-manager-host", "http://10.10.100.148:9953");
        setString("sm-service-file-manager-host", "http://10.10.100.148:9955");
        setString("sm-service-messages-host", "http://10.10.100.148:9956");
    }
