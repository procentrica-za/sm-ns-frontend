...
@Component({
    selector: 'ns-rating-buyerrating',
    templateUrl: './rating-buyerrating.component.html',
    styleUrls: ['./rating-buyerrating.component.scss'],
    moduleId: module.id
})
export class RatingBuyerratingComponent implements OnInit, OnDestroy {
    userid = "";
    ...
    ngOnInit() {
        ...
        this.ratingServ.Previousbuyerratings(userid);
    }
    ngOnDestroy() {
